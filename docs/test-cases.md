...
**Expected Result**:
- 未满 5 张时提示本车已拍摄的车损张数，不显示“拍满 5 张”文案
- 有下一辆车时可选择进入下一辆车或查看已拍
- 最后一辆车或选择查看已拍后进入预览页
- 预览页显示所有已拍摄照片
- 车损数量为 2 张
...
**Expected Result**:
- 第 5 张确认后只显示完成确认弹窗，不自动写入第 6 张
- 尝试第 6 张时提示 `最多5张车损，请先删除`
- 当前车辆车损照片始终不超过 5 张
- 弹窗关闭相机，跳转下一辆车后相机可重新初始化并继续拍照
