...
- 未达到 10 张时留在拍照页继续拍，用户也可以点击 `完成本车拍摄` 主动结束当前车辆车损采集；少于 3 张时先弹出 `车损照片较少` 软确认，3 张及以上直接复用现有当前车辆完成逻辑。
- 车损拍摄页数量只展示 `本车已拍 x 张`，不展示 `x/10` 或剩余可拍数量；第 4 张起拍摄提示显示 `已完成基础采集，可点击完成本车拍摄`。
